...
function RenderSite(){
  ...
  let bodyLayout = [makeEle.createEle('div','header',false,'header-container'),
                    makeEle.createEle('div','bodyIntro',false,['bodyIntro', 'bodyItems']),
                    makeEle.createEle('div','bodyProjects',false,['bodyProjects', 'bodyItems']),
                    makeEle.createEle('div','bodyArt',false,['bodyArt', 'bodyItems']),
                    makeEle.createEle('div','footer',false,'footer-container')];
...
/*
  ...
  For tonight, sept 16, wednesday!

  - Create display modal

  - Move component into seperate file 
...
function GetImgurData() {
 ...
 let gallery = new GallerySlideShow(7,500);
...
GetImgurData()
  ...
  .then(res => {
    ...
    if (Array.isArray(resImages)) {
      gallery.receiveImages(resImages);
  ...
  bodyContainer.append(gallery.renderGallery());
